...
If computation time needs to be minimized, then ALGORITHM is able to produce the most optimal solution in \todo{fill this out}SMALLER NUMBER of ITERATIONS.
