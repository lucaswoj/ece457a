...
As the digital revolution leaves the second digital wave behind, and embraces the robotics wave[1], it is becoming increasingly important to prepare for the multitude of situations where robots will be available to complete various tasks.
...
%  [3] ``A comparative Study between Optimization and Market-based Approaches to Multi-robot Task Allocation''.
...
The goal of this report is to perform a comparative study of meta-heuristic techniques and so this directs the attention of this paper onto an optimization-based approach for solving MRTA. Though Khamis et al. [2] propose a method for using a market-based approach to generate candidate solutions that that then fed into a meta-heuristic algorithm.\\

In [2] Khamis et al. describe a taxonomy for classifying MRTA problems examined in literature. From their taxonomy, the MRTA problem examined by this report has the following classifications:
