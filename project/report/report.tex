...
% TODO discuss choosing alpha to create a balanced cost function
...
While $\alpha$ may be tuned to account for the relative importance of skill vs time for your specific application, as a baseline we reccomend choosing a value that balances
