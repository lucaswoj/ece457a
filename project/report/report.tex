...
As the digital revolution accelerates, electronics have become more than passive desktop appliances \emdash robotics has given computers a means to interact with the world around them, greatly expanding the scope of the tasks we can make them perform.
...
This report is being written as an assignment for the University of Waterloo's ECE457a course, ``cooperative and adaptive algorithms." In it, we will explore using cooperative and adaptive algorithms to find near-optimal solutions to complex task allocation problems for an MRS, with a focus on surveillance tasks.

Complex task allocation, as defined in this assignment's problem statement, is
\mbox{\blockquote{
