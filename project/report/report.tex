...
\newcommand{\Forall}{\mathop{\mbox{\Large $\mathsurround0pt\forall$}}\limits}
...
Complex task allocation is the assignment of complex and simple tasks to a group of robots. This paper is taking an optimization-based approach to solve a multi-task robot, single-robot task, instantaneous assignment version of the multirobot task assignment problem.
...
\mathit{tour \, time}(r, o) =
  ...
  \right) +
  \left(
    \sum^{|o|}_{t=1} \mathit{task \, time}(r, t) \cdot \mathit{velocity}(r)
  \right)
$$
